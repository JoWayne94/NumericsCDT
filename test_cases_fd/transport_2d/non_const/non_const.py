"""
Scalar transport 2D test case with a Gaussian blob
in a non-constant in space velocity field moving back to
...
if __name__ == '__main__':
    ...
    quiver = plt.quiver(X_slice, Y_slice, U_slice , V_slice,
                        angles='xy', scale_units='xy', scale=1, color='k', width=0.001)
    ...
    # Create the GIF
    with imageio.get_writer('non_const.gif', mode='I', duration=0.002) as writer:
